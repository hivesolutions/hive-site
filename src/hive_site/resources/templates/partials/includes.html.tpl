...
<link rel="stylesheet" href="${out_none value=base_path /}resources/libs/jquery_util_ui/slider/css/slider.css" type="text/css" />
<link rel="stylesheet" href="${out_none value=base_path /}resources/libs/jquery_util_ui/slideshow/css/slideshow.css" type="text/css" />
...
<script type="text/javascript" src="${out_none value=base_path /}resources/libs/jquery_util/parse_data/js/parse_data.js"></script>
