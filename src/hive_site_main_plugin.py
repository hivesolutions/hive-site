...
class HiveSiteMainPlugin(colony.base.plugin_system.Plugin):
    """
    The main class for the Hive Site Main plugin.
    """

    id = "pt.hive.hive_site.plugins.main"
    ...
    attributes = {
        "build_automation_file_path" : "$base{plugin_directory}/hive_site_main/main/resources/baf.xml"
    }
    capabilities = [
        "web.mvc_service",
